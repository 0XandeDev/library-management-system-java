...
public class Usuario {
    ...
    public Usuario(int id, String nome, String email, String telefone, String tipo, String senhaHash) {
        this.id = id;
        this.nome = nome;
        this.email = email;
        this.telefone = telefone;
        this.tipo = tipo;
        this.senhaHash = senhaHash != null ? senhaHash : "";
        this.emprestimosAtivos = 0;
    }
    
    public Usuario(int id, String nome, String email, String telefone, String tipo) {
        this(id, nome, email, telefone, tipo, "");
    }
    ...
    public Usuario(String nome, String email, String telefone, String tipo, String senhaHash) {
        this(0, nome, email, telefone, tipo, senhaHash);
    }
    
    public Usuario(String nome, String email, String telefone, String tipo) {
        this(nome, email, telefone, tipo, "");
    }
    ...
    public void setSenhaHash(String senhaHash) { this.senhaHash = senhaHash != null ? senhaHash : this.senhaHash; }
